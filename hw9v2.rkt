...
#reader(lib "htdp-advanced-reader.ss" "lang")((modname hw9v2) (read-case-sensitive #t) (teachpacks ()) (htdp-settings #(#t constructor repeating-decimal #f #t none #f () #f)))
;***** Environment Stuff *****
(define resolve
  (lambda (varName env)
    (cond
...
(define globalCatcher
  (lambda (env)
    (cond
      ((eq? (caar env) 'global) (cons (car env) (cdr env)))
       (else (globalCatcher (cdr env))))))
